  ...
  return (
    <div>
        ...
        {status === "pending" ? (
          ...
          result === 1 ? (
            <div className="bg-[#81b64c] w-full h-full flex justify-center">
              ...
              <span className="headerControls text-[#fff]">Correct</span>
            </div>
          ) : (
            <div className="bg-[#e02828] w-full h-full flex justify-center">
              {/*	lose*/}
              <span>
                <CloseOutlined style={{ fontSize: "90px" }} />
              </span>
              <span className="headerControls text-[#321E2B]">Incorrect</span>
            </div>
          )
        ) : (
          <div className="bg-gray-500 w-full h-full flex justify-center">
            {/*	nothing*/}
            <div className="headerControls text-amber-50">No data found</div>
          </div>
        )}
      </Row>
      <Row>
      ...
      <Row>
        <div className="overflow-auto puzzleStats justify-center w-full">
          <div className="puzzleStatsRow">
            <div className="puzzleStatsText">Title</div>
            <div className="puzzleStatsFlex">
              <strong className="puzzleStatsText">{puzzleData.title}</strong>
            </div>
          </div>
        </div>
      </Row>
      <Row>
        <div className="overflow-auto puzzleStats justify-center w-full">
          <div className="puzzleStatsRow">
            <div className="puzzleStatsText">Date</div>
            <div className="puzzleStatsFlex">
              <strong className="puzzleStatsText">{puzzleData.date}</strong>
            </div>
          </div>
        </div>
      </Row>
