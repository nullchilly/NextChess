...
function ChessBot() {
  return (
    <svg
      ...
      viewBox="0 0 36 36"
    >
      <ellipse cx="33.5" cy="14.5" fill="#F4900C" rx="2.5" ry="3.5"></ellipse>
      <ellipse cx="2.5" cy="14.5" fill="#F4900C" rx="2.5" ry="3.5"></ellipse>
      <path
        fill="#FFAC33"
      ...
      <path
        fill="#269"
        d="M30 5.5C30 6.881 28.881 7 27.5 7h-19C7.119 7 6 6.881 6 5.5S7.119 3 8.5 3h19A2.5 2.5 0 0130 5.5z"
      ></path>
      <path
        fill="#55ACEE"
      ...
      ></path>
      <circle cx="24.5" cy="14.5" r="4.5" fill="#FFF"></circle>
      <circle cx="24.5" cy="14.5" r="2.721" fill="#DD2E44"></circle>
      <circle cx="11.5" cy="14.5" r="4.5" fill="#FFF"></circle>
      <path
        fill="#F5F8FA"
      ...
      <path
        fill="#CCD6DD"
        d="M17 23h2v5h-2zm-5 0h2v5h-2zm10 0h2v5h-2zM7 25.5a2.5 2.5 0 002 2.45v-4.9a2.5 2.5 0 00-2 2.45zm20-2.45v4.899a2.5 2.5 0 000-4.899z"
      ></path>
      <circle cx="11.5" cy="14.5" r="2.721" fill="#DD2E44"></circle>
    </svg>
  );
}
